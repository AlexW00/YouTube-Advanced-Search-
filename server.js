...
let youtube_key = require("./config.json").yt_key;
...
let set_filters = function (req) {
  return new Promise(function (resolve, reject) {
    let low_date = "2000-05-10T19:00:03.000Z",
      high_date = "2900-05-10T19:00:03.000Z";
    let low_time = "0",
      high_time = "999999";
    let type_v = "";
    let order_v = "";
    ...
    if (
      localStorage.getItem("low_time") === null ||
      localStorage.getItem("high_time") === null
    ) {
      //no local storage set yet
    ...
    tube.search(
      ...
      function (error, result, body) {
        ...
        if (error) {
          ...
          for (
            let i = 0;
            i < search_number && result.items[i] != undefined;
            i++
          ) {
